...
public class Database extends DbUtil {
	...
	private static final String SQL_SCHEMA = "src/main/resources/schemaConferencias.sql";
	private static final String SQL_LOAD = "src/main/resources/dataConferencias.sql";
