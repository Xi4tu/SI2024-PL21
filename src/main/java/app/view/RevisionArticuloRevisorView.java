...
public class RevisionArticuloRevisorView {
	...
	private void initialize() {
		...
		DefaultListModel<String> modelArticulos = new DefaultListModel<>();

		listArticulos = new JList<>(modelArticulos);
	...
	public JList<String> getListArticulos() { return this.listArticulos; }
	public JLabel getLblFileName() { return this.lblFileName; }
	public JTextArea getTxtComentariosAutores() { return this.txtComentariosAutores; }
	public JTextArea getTxtComentariosCoordinadores() { return this.txtComentariosCoordinadores; }
	public JComboBox<String> getComboNivelExperto() { return this.comboNivelExperto; }
	public JComboBox<String> getComboDecision() { return this.comboDecision; }
	public JButton getBtnEnviarRevision() { return this.btnEnviarRevision; }
